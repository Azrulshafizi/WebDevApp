...
def load_cart():
    ...
    cart_list = []
    for key in cart_dicts:
        cart = cart_dicts.get(key)
        cart_list.append(cart)
    return cart_list, cart_dicts


products = [
    {'name': 'Product 1', 'price': 25.99},
    {'name': 'Product 2', 'price': 19.99},
    {'name': 'Product 3', 'price': 32.50},
...
def Form():
    ...
    if request.method == "POST":
        ...
        product_size = request.form.get('shoe-size')
        product_colour = request.form.get('shoe-color')
        ...
        try:
            ...
            print("Error retrieving cart from Cart.db")

        cart = Cart.Cart(product_id, product_name, product_price, product_size, product_colour, product_quantity, )

        cart_dict[cart.get_product_id()] = cart
        db['Cart'] = cart_dict
    ...
    return render_template('Product.html', cart_list=cart_list)
...
def catalogue():
    ...
    return render_template('Catalogue.html', products=products, cart_list=cart_list)
...
def cart():
    ...
    #     print(cart.get_product_price())
    #     print(cart.get_product_quantity())
...
@app.route('/shippingaddress')
def shippingaddress():
    return render_template('shippingaddress.html')
